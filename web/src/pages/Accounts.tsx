...
import { getAccounts, createAccount, suspendAccount, unsuspendAccount, terminateAccount, getPackages, getAccountUploadLimit, setAccountUploadLimit } from '../lib/api';
import { Plus, Search, Ban, CheckCircle, Trash2, RefreshCw, Server, Globe, Mail, X, HardDrive, TrendingUp, Database, Users as UsersIcon, Loader2, Upload } from 'lucide-react';
...
export function Accounts() {
  ...
  return (
    ...
    >
      ...
      {/* Create modal */}
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 pt-10 pb-10 overflow-auto" onClick={() => setShowCreate(false)}>
      ...
      {/* Upload Limit Modal */}
      {limitAccount && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 pt-20 pb-10 overflow-auto" onClick={() => setLimitAccount(null)}>
