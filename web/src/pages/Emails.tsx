...
import { getEmails, createEmail, updateEmail, deleteEmail, getDomains, getEmailCount, getAccessToken } from '../lib/api';
import Card from '../components/ui/Card';
import Button from '../components/ui/Button';
import Badge from '../components/ui/Badge';
import EmptyState from '../components/ui/EmptyState';
import Skeleton from '../components/ui/Skeleton';
import { useEmailsReadOnly, ReadOnlyBanner } from '../components/FeatureGate';
...
export function Emails() {
  ...
  const { readOnly } = useEmailsReadOnly();
  ...
  return (
    ...
    >
      ...
      {readOnly && <ReadOnlyBanner text="Email management is disabled for your account — your inbox stays readable, but creating, editing or deleting accounts is blocked." />}
      ...
      {loading ? (
        ...
        <Card>
          <EmptyState
            ...
            message={readOnly ? "Email management is disabled for your account." : "Create an email account to start sending and receiving emails."}
            actionLabel={readOnly ? undefined : "Create Email Account"}
            onAction={readOnly ? undefined : () => setShowCreate(true)}
          />
        </Card>
      ) : (
