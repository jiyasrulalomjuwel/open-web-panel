...
type BarVariant = 'blue' | 'emerald' | 'amber' | 'red' | 'default' | 'warning' | 'danger';
...
export function ProgressBar({ value, max = 100, className = '', size = 'sm', variant = 'blue' }: ProgressBarProps) {
