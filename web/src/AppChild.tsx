...
import { Login, setLoginRedirect } from './pages/Login';
...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  if (!token) {
    // Remember where the user was going so the Site Owner login can return
    // them there (and show the correct panel) after they sign back in.
        ...
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/child" element={<ProtectedRoute><ChildLayout /></ProtectedRoute>}>
              ...
              <Route path="files" element={<PageTransition><FeatureRoute feature="files" title="File Manager"><FileManager /></FeatureRoute></PageTransition>} />
              <Route path="databases" element={<PageTransition><FeatureRoute feature="db" title="Databases"><Databases /></FeatureRoute></PageTransition>} />
              <Route path="backups" element={<PageTransition><FeatureRoute feature="backups" title="Backups"><Backups /></FeatureRoute></PageTransition>} />
              <Route path="cron" element={<PageTransition><FeatureRoute feature="cron" title="Cron Jobs"><CronJobs /></FeatureRoute></PageTransition>} />
              <Route path="domains" element={<PageTransition><Domains /></PageTransition>} />
              <Route path="ftp" element={<PageTransition><FeatureRoute feature="ftp" title="FTP Manager"><FTPManager /></FeatureRoute></PageTransition>} />
