...
OWP_ADMIN_PASSWORD="${OWP_ADMIN_PASSWORD:-$(openssl rand -base64 12 2>/dev/null || tr -dc 'A-Za-z0-9' < /dev/urandom | head -c16)}" \
OWP_HOMES_BASE=./homes/ \
OWP_ADMIN_STATIC_DIR=./web/dist/admin OWP_CHILD_STATIC_DIR=./web/dist/child \
OWP_ADMIN_LISTEN=127.0.0.1:9000 OWP_CHILD_LISTEN=127.0.0.1:9001 \
